...
Sketch.prototype.triangleleft = function(x,y,w,h){
    return this.line(x+w,y,x,y+h/2).line(x,y+h/2,x+w,y+h).line(x+w,y+h,x+w,y);
};
Sketch.prototype.triangleup = function(x,y,w,h){
    return this.line(x,y+h,x+w/2,y).line(x+w/2,y,x+w,y+h).line(x+w,y+h,x,y+h);
};
Sketch.prototype.triangleright = function(x,y,w,h){
    return this.line(x,y,x+w,y/2).line(x+w,y/2,x,y+h).line(x,y+h,x,y);
};
...
//     .draw();
$(function(){
    $('pre[lang=sketch] code, pre code.sketch').sketch();
});
